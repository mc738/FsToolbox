...
module Xml =
    ...
    let getElements (name: XName) (parent: XElement) = parent.Elements name |> List.ofSeq
    ...
    let tryGetAttributeValue (name: string) (element: XElement) =
        tryGetAttribute name element |> Option.bind (fun att -> Some att.Value)

    let getAttributeValueWithDefault (name: string) (defaultValue: string) (element: XElement) =
        tryGetAttributeValue name element |> Option.defaultValue defaultValue
    ...
    let getGuidAttributeValueWithDefault (name: string) (defaultValue: Guid) (element: XElement) =
        tryGetGuidAttributeValue name element |> Option.defaultValue defaultValue
    ...
    let getDateTimeAttributeValueWithDefault (name: string) (defaultValue: DateTime) (element: XElement) =
        tryGetDateTimeAttributeValue name element |> Option.defaultValue defaultValue
    ...
    let getTimespanAttributeValueWithDefault (name: string) (defaultValue: TimeSpan) (element: XElement) =
        tryGetTimespanAttributeValue name element |> Option.defaultValue defaultValue
    ...
    let getIntAttributeValueWithDefault (name: string) (defaultValue: int) (element: XElement) =
        tryGetIntAttributeValue name element |> Option.defaultValue defaultValue
